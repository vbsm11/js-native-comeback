...
// тип данных - стек (первый пришел, последний ушел)
// обязательные условия рекурсии:
// - шаг рекурсии - когда функция вызывает саму себя;
// - база рекурсии – это такие аргументы функции, которые делают задачу настолько простой, что решение не требует дальнейших вложенных вызовов (в нашем случае (16,1)) (то есть условие выхода из рекурсии)
// рекурсия также работает по принципу замыкания